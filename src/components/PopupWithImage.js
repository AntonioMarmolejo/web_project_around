import Popup from "./Popup.js";//Esta clase lo que nos permitirá es que al momento de darle click a una de las imágenes de nuestra página, este se mostrará en la ventana, y ademas tendrá un descripción corta en la parte inferior de la mistma.
