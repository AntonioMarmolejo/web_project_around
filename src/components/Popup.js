class Popup {
    ...
    setEventListeners() {
        const closeButton = this._popup.querySelector(".popup__close-button"); //Cerrar al dar click en el Boton de cerrar
        const allOverlay = this._popup.querySelectorAll(".popup__overlay")
